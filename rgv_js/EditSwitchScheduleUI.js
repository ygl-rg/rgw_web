...
define(["dojo/_base/declare", "dojo/on", "dojo/_base/lang", "dojo/_base/array", "dojo/Evented",
        ...
        "dijit/form/TextBox",
        "dojox/validate", "roundgis/rtutils", "rgv/multi_lang",
        "dojo/text!"+BasicEnv.rgv_template_path+"/edit_switch_schedule_ui.html"],
        ...
        return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
            ...
            startup: function() {
                ...
                on(this.start_time_img_node, "click", lang.hitch(this, function(evt) {
                    WdatePicker({dateFmt:'yyyy/MM/dd', lang:'en', el: this.start_time_input_node.id});
                }));
                on(this.stop_time_img_node, "click", lang.hitch(this, function(evt) {
                    WdatePicker({dateFmt:'yyyy/MM/dd', lang:'en', el: this.stop_time_input_node.id});
                }));
                on(this.hh_mm_img_node, "click", lang.hitch(this, function(evt) {
                    WdatePicker({dateFmt:'HH:mm', lang:'en', el: this.hh_mm_input_node.id});
                }));
            },
            ...
            CheckWorkingSecondsInput: function(val_str1, val_str2, hint_str1, hint_str2) {
                ...
                if(rtutils.IsValidNumber(working_seconds)) {
                    if((working_seconds < 15) || (working_seconds > 9999)) {
