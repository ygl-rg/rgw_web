...
define([], function() {
    return {
        "labels": {
            ...
            "mins": {"eng": "mins", "zho": "分"},
            "secs": {"eng": "secs", "zho": "秒"},
            "auto_off_enabled": {"eng": "enabled auto off", "zho": "开启自动关闭检测"}
        },
        ...
        "errs" : {
            "server_error": {"en": "server error", "zh-cn": "服务错误"},
            "number_format": {"en": "number incorrect", "zh-cn": "输入数字不正确"},
            "timeout": {"en": "time out, please try again later", "zh-cn": "超时,请稍后再试"},
            "no_right": {"en": "permission denied", "zh-cn": "没有权限"}
        }
    };
});